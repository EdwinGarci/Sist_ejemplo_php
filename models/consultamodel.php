        ...
        public function get(){
            ...
            try {
                ...
                while($row = $query->fetch()){
                    $item = new Alumno();//objeto de alumno, abajo se encapsulan las propiedades
                    $item->matricula = $row['matricula'];
                    $item->nombre = $row['nombre'];
                    $item->apellido = $row['apellido'];
                    array_push($items, $item);//inserta datos al arreglo
                }
                return $items;//me retorna el arreglo ya con los datos
